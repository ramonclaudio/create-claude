...
- **GitHub Packages Support**: Added `@ramonclaudio/create-claude` scoped package for GitHub Packages users
...
[0.1.9]: https://github.com/ramonclaudio/create-claude/compare/v0.1.8...v0.1.9
[0.1.8]: https://github.com/ramonclaudio/create-claude/compare/v0.1.7...v0.1.8
[0.1.7]: https://github.com/ramonclaudio/create-claude/compare/v0.1.6...v0.1.7
[0.1.6]: https://github.com/ramonclaudio/create-claude/compare/v0.1.5...v0.1.6
[0.1.5]: https://github.com/ramonclaudio/create-claude/compare/v0.1.4...v0.1.5
[0.1.4]: https://github.com/ramonclaudio/create-claude/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/ramonclaudio/create-claude/compare/v0.1.2...v0.1.3
[0.1.2]: https://github.com/ramonclaudio/create-claude/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/ramonclaudio/create-claude/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/ramonclaudio/create-claude/releases/tag/v0.1.0
